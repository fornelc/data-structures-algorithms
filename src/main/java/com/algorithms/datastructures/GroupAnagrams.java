...
public class GroupAnagrams {
     ...
     *
     * Space Complexity: O(NK), the total information content stored in ans. N would be the number of the strings stored,
     * and K would be the length of each string stored.
     * @param strs
     * @return
     */
