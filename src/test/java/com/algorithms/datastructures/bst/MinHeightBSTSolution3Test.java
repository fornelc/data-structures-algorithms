...
public class MinHeightBSTSolution3Test {
    @Test
    public void TestCase1() {
        List<Integer> array = Arrays.asList(1, 2, 5, 7, 10, 13, 14, 15, 22);
        var tree = MinHeightBSTSolution3.minHeightBst(array);
    ...
    static boolean validateBst(MinHeightBSTSolution3.BST tree) {
        return validateBst(tree, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    static boolean validateBst(MinHeightBSTSolution3.BST tree, int minValue, int maxValue) {
    ...
    static List<Integer> inOrderTraverse(MinHeightBSTSolution3.BST tree, List<Integer> array) {
        if (tree.left != null) {
    ...
    static int getTreeHeight(MinHeightBSTSolution3.BST tree) {
        return getTreeHeight(tree, 0);
    }

    static int getTreeHeight(MinHeightBSTSolution3.BST tree, int height) {
